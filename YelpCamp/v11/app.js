...
var express                 = require("express"),
    ...
    flash                   = require("connect-flash"), // to flash a message to the user
...
// ask our app the use flash package 
app.use(flash());
...
app.use(function(req, res, next){
   ...
   // pass flash to every page's error (res.locals.error) and success (res.locals.success) variables
   // Get an array of flash messages by passing the key to req.flash()
   res.locals.error = req.flash("error");       // "error" here is a key for a flash message 
   res.locals.success = req.flash("success");   // "success" here is a key for a flash message 
